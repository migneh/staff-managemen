...
## تقدم 2026-09-19 — استكمال المرحلة 3/4

- ✅ شفافية النقاط: سجل تاريخي وCSV واعتراضات، وتصدير التقارير المحفوظة.
- ✅ Score قابل للضبط: أوزان مستقلة لـ Helper وSupport+ والإشراف، مجموعها يُتحقق منه ويظهر أثرها في شرح العوامل.
- ✅ onboarding/offboarding: مواعيد، تذكيرات يومية، اعتماد بشري قبل `probation → active`، ومهام تسليم مرتبطة بآخر يوم.
- ✅ الاعتراف والاستئنافات: ترشيحات تقدير محدودة مع اعتماد، وقناة `staff-wins` اختيارية، واستئناف الإنذارات مع عكس النقاط عند الإلغاء.
- ✅ التشغيل: Health/metrics وCompose/systemd موجودان، من دون إضافة PostgreSQL؛ SQLite ما زالت قاعدة البيانات الوحيدة.

تظل أفكار التوسعة غير المطلوبة حالياً (تبادل الإجازات، شارات الاعتراف، وتنبيهات التكتات المفتوحة التي لا يسجلها هذا البوت) خارج هذا التمرير لأنها تحتاج مصدراً أو قراراً إضافياً.
