...
> ## ✅ ما أُنجز (2026-09-18)
>
> **المرحلة 0 (الثقة)** و**المرحلة 1 (سهولة التطوير)** مكتملتان في الإصدار 1.1.0:
...
> التفاصيل في [`CHANGELOG.md`](./CHANGELOG.md). ما تبقى هنا (المرحلتان 2 و3) صار
> أسهل تنفيذاً لأن الأساس صار مختبراً.
